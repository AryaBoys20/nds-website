...
<section id="tim" class="section-padding">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center flex-wrap mb-4">
            <h2 class="section-title mb-0"><?= e($lang['tim_title'] ?? 'Management & Team') ?></h2>
            <span class="employee-badge animate-pulse"><i class="bi bi-people-fill"></i> 85+ <?= e($lang['tim_karyawan'] ?? 'Employees') ?></span>
        </div>
        <div class="row g-4">
            <div class="col-md-4 animate-fade-up delay-1">
                <div class="card card-hover h-100 text-center p-3">
                    <img src="assets/img/team/ceo.png" 
                         alt="CEO" class="profile-img mx-auto mt-2">
                    <div class="card-body">
                        <h5 class="fw-bold">Muhammad Arya Pratama, S.Kom</h5>
                        <span class="badge bg-nds-primary"><?= e($lang['tim_ceo'] ?? 'CEO') ?></span>
                        <p class="small mt-2 text-secondary"><?= e($lang['tim_ceo_desc'] ?? 'Former McKinsey IT Consultant, 15 years experience.') ?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 animate-fade-up delay-2">
                <div class="card card-hover h-100 text-center p-3">
                    <img src="assets/img/team/cto.png" 
                         alt="CTO" class="profile-img mx-auto mt-2">
                    <div class="card-body">
                        <h5 class="fw-bold">Dr. Purnama Aditya, M.Sc.</h5>
                        <span class="badge bg-nds-primary"><?= e($lang['tim_cto'] ?? 'CTO') ?></span>
                        <p class="small mt-2 text-secondary"><?= e($lang['tim_cto_desc'] ?? 'Doctor of Computer Science (Univ. Tokyo), Machine Learning expert.') ?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 animate-fade-up delay-3">
                <div class="card card-hover h-100 text-center p-3">
                    <img src="assets/img/team/coo.png" 
                         alt="COO" class="profile-img mx-auto mt-2">
                    <div class="card-body">
                        <h5 class="fw-bold">Naufal Hafizd Nuruddin, B.Eng.</h5>
                        <span class="badge bg-nds-primary"><?= e($lang['tim_coo'] ?? 'COO') ?></span>
                        <p class="small mt-2 text-secondary"><?= e($lang['tim_coo_desc'] ?? 'Project management specialist, PMP & Scrum certified.') ?></p>
                    </div>
                </div>
            </div>
        </div>
